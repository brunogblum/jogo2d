...
const falas = {
  ...
  point2: `<div>Aqui você encontra meus <strong>projetos web</strong>: criei sistemas com Python e Flask, incluindo automação de tarefas e aplicações de previsão do tempo.</div><div><strong>Habilidades:</strong> HTML, CSS, JavaScript, Flask, integração com APIs.</div><div><a href="https://seusite.com/projeto-web" target="_blank">Exemplo de aplicação online</a></div><div style="text-align:center; font-size:0.9em;"><br>(Clique ou caminhe para fechar)</div>`,
  point3: `<div>Este ponto destaca projetos de <strong>automação e integração</strong>: bots para WhatsApp Web, sistemas de monitoramento e notificações automáticas.</div><div><strong>Habilidades:</strong> Python, Selenium, API do WhatsApp, manipulação de DOM, automação de processos.</div><div><a href="https://github.com/seuusuario/bot-whatsapp" target="_blank">Veja um projeto de automação</a></div><div style="text-align:center; font-size:0.9em;"><br>(Clique ou caminhe para fechar)</div>`,
